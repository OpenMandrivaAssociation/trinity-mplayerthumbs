...
%lang(ka) %{tde_datadir}/locale/ka/LC_MESSAGES/mplayer-thumbnailer.mo
%lang(nl) %{tde_datadir}/locale/nl/LC_MESSAGES/mplayer-thumbnailer.mo
%lang(pl) %{tde_datadir}/locale/pl/LC_MESSAGES/mplayer-thumbnailer.mo
